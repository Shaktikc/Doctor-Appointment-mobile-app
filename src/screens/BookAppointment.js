...
export default function BookAppointment({ route, navigation }) {
  ...
  const { saveAppointment, bookedAppointments, isSlotBooked } =
    useBookAppointment();
  ...
  const maxDate = moment()
    .add(APPOINTMENT_BOOKING_RANGE_MONTHS, "months")
    .format("YYYY-MM-DD");
        ...
        <View style={styles.header_container}>
          ...
          <View>
            <View style={styles.title_container}>
              ...
              <Text style={styles.about}>{doctor.categories[0]} Specialist</Text>
            </View>
            ...
            {loading ? (
              ...
              <>
                ...
                {serviceTimeList.length === 0 ? (
                  <View style={styles.no_slots_container}>
                    <Text style={styles.no_slots_message}>
                      Doctor is not available on this day, please select a
                      different day
                    </Text>
                  </View>
                ) : (
